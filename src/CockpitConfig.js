        ...
        items: [
            {
                name: 'Author',
                type: 'group',
                items: _(Languages).filter((lang) => lang.code !== 'en').map((lang) => buildDataView('author', lang, true)).value()
            },
            {
                name: 'Publisher',
                type: 'group',
                items: _(Languages).filter((lang) => lang.code !== 'en').map((lang) => buildDataView('publisher', lang, true)).value()
            },
            {
                name: 'Category',
                type: 'group',
                items: _(Languages).filter((lang) => lang.code !== 'en').map((lang) => buildDataView('category', lang, true)).value()
            }
        ]
    },
    {
